...
data class Video(val video_id: String, val complete_url: String, val complete: String, val title: String, val thumbnail: String, val score: Int, val formats:List<Format>)
...
data class Format(val type: String, val uri: String, val version:Int)
